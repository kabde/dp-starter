...
if (!post_type_exists('tool')) {
    ...
    echo '<h1>' . esc_html__('Tools', 'dp-starter') . '</h1>';
    echo '<p>' . esc_html__('This feature requires a premium license. Activate your license in DP Starter Settings to unlock Tools.', 'dp-starter') . '</p>';
    echo '</div></div></div>';
    get_footer();
    return;
}
